...
var radius = 1.0;
var rotationAngle = 0; // Base rotation angle in degrees
...
function tessellaTriangle(a, b, c) {
    // Apply rotation to each vertex based on distance to origin
    a = rotateVertexByDistance(a, rotationAngle);
    b = rotateVertexByDistance(b, rotationAngle);
    c = rotateVertexByDistance(c, rotationAngle);
...
function rotateVertexByDistance(vertex, baseAngle) {
    ...
    // Adjust rotation angle based on distance
    var angle = baseAngle * distance;
